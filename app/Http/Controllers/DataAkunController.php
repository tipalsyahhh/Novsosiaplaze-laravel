...
class DataAkunController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dataAkun.index', compact('dataAkun', 'firstname', 'lastname', 'user', 'userProfile', 'products', 'statuses', 'statusCount', 'follows', 'likes', 'postingan'));
    }
    ...
    public function setting(Request $request)
    {
        ...
        return view('dataAkun.setting', compact('dataAkun', 'firstname', 'lastname', 'user', 'userProfile', 'products', 'statuses', 'statusCount', 'follows', 'likes', 'postingan'));
    }
    ...
    public function show($dataAkunId)
{
    ...
    public function create(Request $request)
    {
        ...
        return view('dataAkun.create', compact('firstname', 'lastname', 'user', 'products', 'follows', 'likes', 'postingan'));
    }
    ...
    public function edit($user_id, Request $request)
    {
        ...
        return view('dataAkun.edit', compact('dataAkun', 'firstname', 'lastname', 'user', 'products', 'follows', 'likes', 'postingan'));
    }
