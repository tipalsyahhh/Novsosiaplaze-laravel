...
<div class=header-market>
    ...
    <div class="keranjang-market">
        <a class="nav-link" href="{{ route('keranjang.index') }}">
            <i class="bi bi-cart-check" style="color: #333; font-size: 1.8em;"></i>
                    ...
                    <div class="detail-harga">
                        ...
                        <div class="produk-isi">
                            <p class="description">
                                ...
                                <span class="desktop-text">{{ substr($post->deskripsi, 0, 100) }}</span>
                                <span class="mobile-text">{{ substr($post->deskripsi, 0, 25) }}</span>...
                            </p>
                        </div>
...
<p style="color: #333; margin-bottom: -5px; margin-top: 10px; font-size: 20px; font-weight: bold;">Kategori</p>
        ...
        <div class="card-market product-item post" style="margin-top: 20px; position: relative;" data-jenis="{{ $post->jenis }}">
            <a href="{{ route('detailProduct', ['id' => $post->id]) }}">
                ...
                <div class="produk-isi">
                    ...
                    @endif
                    <p><i class="fas fa-tags ml-2"></i> {{ $post->jenis }}</p>
                </div>
                <div class="info-post">
                    <p class="harga-masuk"><span>Rp {{ number_format($post->harga, 0, ',', '.') }}</span></p>
